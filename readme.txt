=== N360 | Splash Screen ===
Contributors: bistromatic
Donate link: https://notion360.com/donate/
Tags: splash page, splash screen, splash landing page, responsive design, background image, full screen page, fade-in, fade-out
...
To see it at work, take a look at our [N360 Splash Screen sample page](https://notion360.com/SplashScreen/ "Our awesome splash screen demo.").
...
= 1.0.5 =
* added <meta> tags to improve google search results
= 1.0.6 =
* changed $_SERVER call to improve cookie handling
= 1.0.7 =
* fixed XSS (Cross-Site Scripting) vulnerability
